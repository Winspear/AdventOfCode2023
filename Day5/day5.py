...
"""
def get_destination_from_next_map(lines, map_start_value, destination_from_previous_step):
...
def part1():
    with open('input.txt', 'r') as myinput:
        ...
        for destination_from_previous_step in split_seeds:
            for map_start_value in map_start_values:
                destination_from_previous_step = get_destination_from_next_map(lines, map_start_value, destination_from_previous_step)
            if not lowest_destination or (int(destination_from_previous_step) < int(lowest_destination)):
                lowest_destination = destination_from_previous_step
